...
class Contract:
    ...
    def __init__(self, **kwargs) -> None:
        self.client: str = kwargs.get("client")
    ...
    def fulfill(self):
        result = self.client.my.contracts.fulfill(self.id_)
        pprint(result)
        return result

    def accept(self):
        result = self.client.my.contracts.accept(self.id_)
        pprint(result)
        return result
    ...
    def deliver(self, ship: Ship):
        ...
        result = self.client.my.contracts.deliver(
